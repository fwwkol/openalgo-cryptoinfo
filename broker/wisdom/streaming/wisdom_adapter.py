...
from .wisdom_mapping import WisdomExchangeMapper, WisdomCapabilityRegistry
...
class WisdomWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def __init__(self):
        ...
        self.logger.info(f"Wisdom adapter initialized with ZMQ port: {self.zmq_port}")
    ...
    def initialize(self, broker_name: str, user_id: str, auth_data: Optional[Dict[str, str]] = None) -> None:
        ...
        self.logger.info(f"Using API Key: {api_key[:10]}... for Wisdom XTS connection")
    ...
    def _connect_with_retry(self) -> None:
        ...
        while self.running and self.reconnect_attempts < self.max_reconnect_attempts:
            try:
                self.logger.info(f"Connecting to Wisdom XTS WebSocket (attempt {self.reconnect_attempts + 1})")
    ...
    def disconnect(self) -> None:
        ...
        self.logger.info("*** DISCONNECT CALLED - Starting Wisdom disconnect process ***")
    ...
    def cleanup_zmq(self) -> None:
        ...
        try:
            ...
            self.logger.info("Wisdom WebSocket cleanup completed successfully")
        except Exception as e:
    ...
    def _on_data(self, wsapp, message) -> None:
        ...
        try:
            self.logger.info(f"RAW WISDOM DATA: Type: {type(message)}, Data: {message}")
